package no.nav.oebs.digihot.db.entity;
...
@Setter
@ToString
@Table(name = "XXRTV_DIGIHOT_LOGG", schema = "XXRTV")
public class KallLogg {
	...
	@Id
	@SequenceGenerator(name = "XXRTV_DIGIHOT_API_SEQ", sequenceName = "XXRTV_DIGIHOT_API_SEQ", schema = "XXRTV", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "XXRTV_DIGIHOT_API_SEQ")
